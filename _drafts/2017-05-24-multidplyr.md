...
In this case, multidplyr runs up to 4.3 times faster on a 16 processor.  The speed enchancement appears to be linear with respect to increasing size of the dataset.
